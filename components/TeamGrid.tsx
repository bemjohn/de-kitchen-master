...
const executiveTeam = [
  ...
  },
  {
    ...
    image: "/team/chef_happiness.jpeg",
    location: "Lagos, Nigeria",
    experience: "10 Years Experience",
    bio: "Chef Happiness is a seasoned culinary professional with over 10 years of experience in the hospitality industry, building a reputation for culinary excellence, operational efficiency, and innovative kitchen leadership. Throughout her career, she has developed expertise in menu creation, recipe development, food costing, procurement, staff supervision, and kitchen administration. Her passion for creating exceptional dining experiences is matched by her ability to optimize restaurant operations and mentor culinary teams. As Executive Chef and Assistant Restaurant Consultant at De KITCHEN MASTER, she plays a key role in delivering creative culinary solutions, improving food operations, and supporting hospitality businesses through strategic consultancy and professional excellence.",
  },
  {
    name: "Chef Buzor (Mbika Chibuzor Franklyn)",
    role: "Executive Sous Chef | Menu & Recipe Development Specialist",
    image: "/team/chef_buzor.jpeg",
    location: "Lagos, Nigeria",
  ...
  {
    name: "Chef V (Attai Vincent)",
    role: "Senior Executive Sous Chef | Abuja Operations Manager",
    image: "/team/chef_v.jpeg",
  ...
  },
  {
    ...
    location: "Lagos, Nigeria",
    experience: "15 Years Experience",
    bio: "Chef DadyK is a passionate and visionary culinary professional with over 15 years of experience in the hospitality industry. Holding a Bachelor's Degree in Culinary Arts, he has established himself as an exceptional kitchen leader, recognized for outstanding customer service, calm decision-making under pressure, and the ability to develop high-performing culinary teams. Professionally trained in both Nigerian and Continental cuisine, his greatest passion is promoting and elevating Nigerian cuisine by blending world-class culinary techniques with indigenous ingredients and authentic flavours. As Senior Sous Chef & Talent Manager at De KITCHEN MASTER Culinary & Hospitality Services Ltd, he leads talent identification, chef mentorship, skills development, and culinary excellence initiatives while supporting the company's vision of building Africa's next generation of world-class culinary professionals.",
  },
  {
    name: "Chef Joy (Joy James)",
    role: "Sous Chef | Catering & Event Coordinator – Level 2",
    image: "/team/chef_joy.jpeg",
    location: "Lagos, Nigeria",
