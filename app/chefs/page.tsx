...
const chefCategories = [
  {
    ...
    chefs: [
      ...
      { name: "Chef Ben", role: "Operational Chef", experience: "7 Years", specialty: "Large-Scale Food Production & Kitchen Operations", location: "Awka, Anambra State, Nigeria", availability: "Available", image: "/images/chefs/chef_ben.jpeg", fullDescription: "A dedicated Operational Chef with seven years of professional experience, specializing in large-scale food production and kitchen operations. Experienced in high-volume cooking with roles at Stanel World and Napoleon by Ibiza, bringing efficiency, consistency, and strong operational expertise to every culinary service." },
    ],
  },
  {
    ...
    chefs: [
      ...
      { name: "Chef Chi", role: "Head Chef | Residential Chef", experience: "5+ Years", specialty: "Intercontinental Cuisine, Grilling & Pastries", location: "Lagos, Nigeria", availability: "Available", image: "/images/chefs/chef_chi.jpeg", fullDescription: "A versatile Head Chef and Residential Chef with over five years of experience, specializing in Intercontinental cuisine, grilling, and pastries. Dedicated to culinary excellence, personalized dining experiences, and exceptional service across restaurants, lounges, hotels, and private residences." },
    ],
  },
  {
